...
import { DartDebugMessageAnonymous as DartDebugMessageAnonymous } from './DartDebugMessageAnonymous';
import {
...
export class DartDebugMessage extends DebugMessage {
  jsDebugMessageAnonymous: DartDebugMessageAnonymous;
  constructor(
    lineCodeProcessing: LineCodeProcessing,
    debugMessageLine: DebugMessageLine,
  ) {
    super(lineCodeProcessing, debugMessageLine);
    this.jsDebugMessageAnonymous = new DartDebugMessageAnonymous(
      lineCodeProcessing,
    );
  }
